...
namespace PortaleRegione.Persistance
{
    ...
    public class PersoneRepository : Repository<View_UTENTI>, IPersoneRepository
    {
        ...
        public async Task<IEnumerable<View_UTENTI>> GetAll_DA_CANCELLARE()
        {
            var query = PRContext
                .View_UTENTI
                .Where(u => u.UID_persona != Guid.Empty)
        ...
        public async Task<IEnumerable<UTENTI_NoCons>> GetSegreteriaGiuntaRegionale(int id, bool notifica_firma,
