...
namespace GeneraStampeJob
{
    public class Genera : IJob
    {
        ...
        private string urlCLIENT { get; set; }
        private string CartellaStampeLink { get; set; }
        private string NumMaxTentativi { get; set; }
        private string CartellaLavoroTemporanea { get; set; }
        private string CartellaLavoroStampe { get; set; }
        private string SMTP { get; set; }
        private string EmailFrom { get; set; }
        private string RootRepository { get; set; }
        private bool InvioNotifiche { get; set; }
